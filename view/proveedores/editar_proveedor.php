...
<head>
    ...
    <title>SYSRAR - Editar Proveedor</title>
    ...
    <div id="gif-carga" class="container-fluid ocultar cont-desktop">
        <div class="px-5 py-3 d-flex flex-column">
            <div class="col ps-4">
                ...
                <p class="text-muted"><i class="fa-solid fa-edit"></i> Editar Proveedor</p>
            </div>
                ...
                <form method="POST" class="p-3">
                    <div class="row">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <button type="submit" id="editar_proveedor" class="btn btn-primary"><i class="fa-solid fa-floppy-disk"></i> Editar Proveedor</button>
                        </div>
                    </div>
                </form>
            </div>
