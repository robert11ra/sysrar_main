...
<head>
    ...
    <title>SYSRAR - Editar Usuario</title>
    ...
    <div id="gif-carga" class="container-fluid ocultar cont-desktop">
        <div class="px-5 py-3 d-flex flex-column">
            <div class="col ps-4">
                ...
                <p class="text-muted"><i class="fa-solid fa-plus"></i> Editar Usuario</p>
            </div>
            <div class="container-fluid mt-3 shadow-lg rounded mb-3">
                <form method="POST" class="p-3">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6 mb-3">
                            <label for="select_roles" class="form-label">Rol<span class="text-danger">*</span></label>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <button type="submit" id="editar_usuario" class="btn btn-primary"><i class="fa-solid fa-floppy-disk"></i> Editar Usuario</button>
                        </div>
                </form>
            </div>
        </div>
