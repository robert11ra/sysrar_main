...
<head>
    ...
    <title>SYSRAR - Facturas Pendientes</title>
    ...
    <div id="gif-carga" class="container-fluid ocultar cont-desktop">
        <div class="px-5 py-3 d-flex flex-column">
            <div class="col ps-4">
                ...
                <p class="text-muted">Lista de Facturas Pendientes</p>
            </div>
            <div class="row mt-3 justify-content-evenly">
                <div class="col-12">
                    <div class="card2 shadow-lg p-4">
                        <div class="row">
                            <div class="col-7">
                                <h6 class="mb-0">Facturas Pendientes</h6>
                                <p class="text-muted">Tabla de Facturas Pendientes</p>
                            </div>
                        ...
                        <table id="tabla_facturas_pendientes" class="table table-hover">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Fecha</th>
