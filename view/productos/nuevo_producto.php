...
<head>
    ...
    <title>SYSRAR - Agregar Producto</title>
                ...
                <form class="p-3">
                    <div class="row">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <button type="submit" id="registrar_producto" class="btn btn-primary"><i class="fa-solid fa-floppy-disk"></i> Crear Producto</button>
                        </div>
                </form>
            </div>
        </div>
